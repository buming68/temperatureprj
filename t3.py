...
class SettingWindow(QMainWindow):
    ...
    def saveSetting(self):
        ...
        self.confParse.set('alarm_setting', '12', self.ui.lineEdit_12.text())
        self.confParse.set('alarm_setting', '13', self.ui.lineEdit_13.text())
        self.confParse.set('alarm_setting', '14', self.ui.lineEdit_14.text())
        self.confParse.set('alarm_setting', '15', self.ui.lineEdit_15.text())
        self.confParse.set('alarm_setting', '16', self.ui.lineEdit_16.text())
        self.confParse.set('alarm_setting', '17', self.ui.lineEdit_17.text())
        self.confParse.set('alarm_setting', '18', self.ui.lineEdit_18.text())
        self.confParse.set('alarm_setting', '19', self.ui.lineEdit_19.text())
        ...
        self.confParse.set('address_setting', 'a12', self.ui.lineEdit_A12.text())
        self.confParse.set('address_setting', 'a13', self.ui.lineEdit_A13.text())
        self.confParse.set('address_setting', 'a14', self.ui.lineEdit_A14.text())
        self.confParse.set('address_setting', 'a15', self.ui.lineEdit_A15.text())
        self.confParse.set('address_setting', 'a16', self.ui.lineEdit_A16.text())
        self.confParse.set('address_setting', 'a17', self.ui.lineEdit_A17.text())
        self.confParse.set('address_setting', 'a18', self.ui.lineEdit_A18.text())
        self.confParse.set('address_setting', 'a19', self.ui.lineEdit_A19.text())
